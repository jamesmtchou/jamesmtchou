...
import {Array2D, webgl_util} from 'deeplearn';
...
export function addLatentVariables(
    gpgpu, addZShader, sourceTex,
    resultTex, shapeRowCol, z1,
    z2) {
...
export function render(
    gpgpu, renderShader, sourceTex,
    outputNumDimensions, colorMode) {
